    ...
    <div class="block sm:hidden">
        @if ($leaveRequests->isEmpty())
            <div class="bg-gray-50 rounded-lg p-8 text-center border border-gray-200">
                ...
                <p class="text-gray-600 font-medium">Belum ada riwayat pengajuan izin</p>
                <p class="text-gray-500 text-sm mt-1">Izin dan cuti yang diajukan akan ditampilkan di sini</p>
            </div>
        @else
            <div class="space-y-3">
                            ...
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <div class="flex items-center mb-2">
                                        <div
                                            class="p-1.5 rounded-md {{ $leave->type === 'sick' ? 'bg-red-100' : 'bg-blue-100' }} mr-3">
                                            @if ($leave->type === 'sick')
            ...
            <div class="overflow-hidden">
                <table class="min-w-full divide-y divide-gray-200">
                    <thead>
                        <tr>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide border-r border-gray-100">
                                Tanggal
                            </th>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide border-r border-gray-100">
                            ...
                            <th
                                class="hidden sm:table-cell px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide border-r border-gray-100">
                                Alasan
                            </th>
                            <th
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wide border-gray-100">
                                Status
                            </th>
                        </tr>
                    </thead>
                    <tbody class="bg-white divide-y divide-gray-200">
                        @foreach ($leaveRequests as $leave)
                            <tr>
                                ...
                                <td
                                    class="hidden sm:table-cell px-6 py-4 text-sm text-gray-900 border-r border-gray-100">
